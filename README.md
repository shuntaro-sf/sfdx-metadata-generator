...
running command...
$ sfdx (--version)
sfdx-metadata-generator/1.5.5 win32-x64 node-v18.16.0
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
running command...
$ sfdx (--version)
sfdx-metadata-generator/1.5.4 win32-x64 node-v18.16.0
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
running command...
$ sfdx (--version)
sfdx-metadata-generator/1.2.5 win32-x64 node-v18.16.0
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...

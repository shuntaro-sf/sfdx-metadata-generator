...
const inputFileName = "field_relationPositiveTestInput.csv";
const outputDir = "force-app/main/default/objects/Custom_Object__c/fields/";

describe("FieldRelationPositiveTest", () => {
  ...
  it("converts generated metadata to a csv file", async (done) => {
    shell.exec("sfdx metadata:field:convert -s " + outputDir + " -o ../");
    done();
  });
